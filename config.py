...
API_ID = int(getenv("22332222", ""))
API_HASH = getenv("abdfc348d1350682e9323888af8cd7f4")

# ADMIN DETAILS (Your ID) 
OWNER_ID = int(getenv("@Shinu_han", ""))

OWNER_NAME = getenv("Sinu_han") 
SUDO_USER= list(
    map(int, getenv("SUDO_USER", "6248129136").split())
)
